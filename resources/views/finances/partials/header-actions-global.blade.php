<a href="{{ route('finances.insolvables', ['year_id' => $selectedYear?->id]) }}" 
   class="fin-action no-print flex-row items-center gap-2 whitespace-nowrap rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-xs font-bold text-gray-700"
   style="display:inline-flex;flex-direction:row;align-items:center;gap:.5rem;white-space:nowrap;">
